...
public class exercise_02d_inf {
	...
	public static void main(String[] args) {
		...
		if (args.length == 3) {
			...
			try {
				exercise_02d_inf.process(filein1, filein2, fileout);
			} catch (IOException e) {
	...
	public static void process(String filein1, String filein2, String fileout) throws IOException {
		 ...
		 */
		System.out.println("image1-size=" + img_filein1.width + "x" + img_filein1.height);
		System.out.println("image2-size=" + img_filein2.width + "x" + img_filein2.height);

		if (img_filein1.width == img_filein2.width && img_filein1.height == img_filein2.height) {
			System.out.println("same size, getInf()");
			GrayU8 img_out = getInf(img_filein1, img_filein2);
	...
	// than both a and b
	private static GrayU8 getInf(GrayU8 img_filein1, GrayU8 img_filein2) {
